#python optim_heisenbergs1.py --tiling 1SITE --bond_dim 10 --seed 123 --J2 0.0 --N 10 --CTMARGS_fwd_checkpoint_move --OPTARGS_tolerance_grad 1.0e-8 --out_prefix ex-mps
import context
import scipy.io
import torch
import argparse
...
parser.add_argument("--J2", type=float, default=0., help="transverse field")
parser.add_argument("--N", type=int, default=10, help="number of spins")
parser.add_argument("--tiling", default="BIPARTITE", help="tiling of the lattice")
args, unknown_args = parser.parse_known_args()

mat = scipy.io.loadmat('tensor_D_12.mat')
...
def main():
    ...
    model = heisenbergs1.Heisenbergs1(J1=args.J1, J2=args.J2, N=args.N)
