...
parser.add_argument("--J", type=float,default=1.,help="nearest-neighbour coupling")
parser.add_argument("--delta", type=float, default=1., help="anisotropic factor")
parser.add_argument("--gx",type=float,default=1.,help="gyromagnetic ratio")
parser.add_argument("--h",type=float, default=1.,help="transverse magnetic field")
